-- Fix duplicate rent category helper text[] concatenation.
--
-- 202605210001 created public.merge_duplicate_rent_category but attempted to
-- append text to text[] directly. PostgreSQL requires appending a text[] value.
